...
// post: The binary tree is initialized to a deep copy of copyMe, with root
//       pointing to the top node and mSize == copyMe.mSize.

// binarytree operator=(const binarytree& copyMe);
// post: The binary tree is cleared, then a deep copy of copyMe is put into
//       it, with root pointing to the top node and mSize == copyMe.mSize.

// ~binarytree();
// post: The binary tree is cleared.
...
private:
	...
	static void copy(treenode*& rootLeft, size_type& sizeLeft, const treenode* rootRight);
	static void clear(treenode*& root, size_type& mSize);
	...
	static void toLL_aux(const treenode* root, LL<value_type>& list);
};
#endif